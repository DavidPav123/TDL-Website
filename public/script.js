...
function highlightRows() {
  ...
  for (var i = 1; i < homeworkTable.rows.length; i++) {
    ...
    var dueDate =
      new Date(homeworkTable.rows[i].cells[2].innerHTML).getTime() +
      36000000 +
      parseInt(dueTime[0]) * 3600000 +
      parseInt(dueTime[1]) * 60000;
  ...
  while (switching) {
    ...
    for (i = 1; i < homeworkTable.rows.length - 1; i++) {
      ...
      var dueDate1 =
        new Date(homeworkTable.rows[i].cells[2].innerHTML).getTime() +
        36000000 +
        parseInt(dueTime1[0]) * 3600000 +
        parseInt(dueTime1[1]) * 60000;
      var dueTime2 = homeworkTable.rows[i + 1].cells[3].innerHTML.split(":");
      var dueDate2 =
        new Date(homeworkTable.rows[i + 1].cells[2].innerHTML).getTime() +
        36000000 +
        parseInt(dueTime2[0]) * 3600000 +
        parseInt(dueTime2[1]) * 60000;
    ...
    if (shouldSwitch) {
      (_a = homeworkTable.rows[i].parentNode) === null || _a === void 0
        ? void 0
        : _a.insertBefore(homeworkTable.rows[i + 1], homeworkTable.rows[i]);
      switching = true;
    }
  }
}
...
homeworkForm === null || homeworkForm === void 0
  ? void 0
  : homeworkForm.addEventListener("submit", function (event) {
      ...
      var homeworkName =
        (_a = document.getElementById("homework-name")) === null ||
        _a === void 0
          ? void 0
          : _a.value;
      var homeworkDueDate =
        (_b = document.getElementById("homework-due-date")) === null ||
        _b === void 0
          ? void 0
          : _b.value;
      var homeworkSubject =
        (_c = document.getElementById("homework-subject")) === null ||
        _c === void 0
          ? void 0
          : _c.value;
      var homeworkDueTime =
        (_d = document.getElementById("homework-due-time")) === null ||
        _d === void 0
          ? void 0
          : _d.value;
      // create a new row in the table
      var row =
        homeworkTable === null || homeworkTable === void 0
          ? void 0
          : homeworkTable.insertRow();
...
homeworkTable === null || homeworkTable === void 0
  ? void 0
  : homeworkTable.addEventListener("dblclick", function (event) {
      var _a;
      var row = event.target.parentNode;
      (_a = row.parentNode) === null || _a === void 0
        ? void 0
        : _a.removeChild(row);
    });
